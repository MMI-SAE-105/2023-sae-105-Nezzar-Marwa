...
- Url de la maquette : https://www.figma.com/file/ySzd5EtEjR1GU2zq7mK7mF/SAE-105-(2022)-(Copy)?type=design&node-id=322%3A1210&t=aVwvFU77ol9OQqsv-1
...
- [x] Donnez l'adresse IP de votre VPS : 45.155.169.191

- [x] Donnez le login et le mot de passe admin du compte pocketbase : le login: marwa.nezzar@edu.univ-fcomte.fr  le mot de passe: MarwaNSAE203

- [x] Donnez l'URL du backend `http://.../_/` (IP ou dommaine) : http://r203orientalisme.marwa-nezzar.fr/_/#/login

- [x] Donnez l'URL du frontend `http://.../` (IP ou domaine) : http://r203orient.marwa-nezzar.fr/

- [x] Donnez l'URL HTTP**S** du frontend `https://foo.bar/` (nom de dommaine) : https://r203orient.marwa-nezzar.fr/
